...
parser.add_argument('models_dir', metavar='<models_dir>', type=str, nargs=1)
parser.add_argument('router_conf', metavar='<router_intf_conf>', type=str, nargs=1)
parser.add_argument('routes', metavar='<paths>', type=str, nargs=1)
args = parser.parse_args()

#MODELS_DIR = '/home/miniNExT/examples/master_thesis/project/trained_models/lstm/'
#MODELS_DIR = '/home/miniNExT/examples/master_thesis/project/trained_models/dnn/'
MODELS_DIR = args.model_dir
ROUTERS_NAMING = ['r{:}'.format(i+1) for i in range(10)]

#ROUTER_CONF = '/home/miniNExT/examples/master_thesis/project/configs/interfaces'
ROUTER_CONF = args.router_conf
SELECTED_T = ['r1_172_168_4_1', 'r2_172_168_4_2', 'r3_172_168_35_1','r4_172_168_35_1', 'r6_172_168_32_1']
SELECTED_T = ['r1_172_168_3_1']

#ROUTES = '/home/miniNExT/examples/master_thesis/project/testing/run0/paths.txt'
ROUTES = args.routes
ITERATIONS = 1
SAMPLES = 200
